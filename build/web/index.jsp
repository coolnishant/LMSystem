	...
	<div class="header-w3ls-agileinfo">
			...
			<div class="wthree_agile_top_header">
				<div class="logo-agileits">
					<h1><a href="index.jsp"><span>E</span>-learning <i class="fa fa-graduation-cap" aria-hidden="true"></i></a></h1>
				</div>
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="#team" class="hvr-rectangle-out scroll">Team</a></li>
								<li><a href="#news" class="hvr-rectangle-out scroll">Latest Arrival</a></li>
															...
															<div class="modal-content">
																<div class="modal-header">
																	...
																	<h3 class="agileinfo_sign">Sign In</h3>	
																			...
																			<p><a href="#" data-toggle="modal" data-target="#myModal4" > Don't have an account?</a></p>
																		</div>
																</div>
															</div>
														</div>
																			...
																			<div class="login-form">
																				<form action="#" method="post">
																				   <input type="text" name="name" placeholder="Enter Your Fullname" required>			   
                                                                                    ...
                                                                                    <option value="india">India</option>                                                              <option value="pakistan">Pakistan</option>                                                              <option value="bangladesh">Bangladesh</option>                                                              <option value="china">China</option>
                                                                                    </select>
																				...
																				<form action="#" method="post">
																				   <input type="text" name="name" placeholder="Name of the Candidate" required>
                                                                                    <input type="email" name="email" placeholder="Email" required>
																					 ...
																					 <input type="text" name="dob" placeholder="Date Of Birth" id="datepicker" required>
...
<!-- gallery -->
	<div class="gallery" id="gallery">
	 <div class="w3ls-heading">
				...
				<p class="sub">Learning never exhausts the Mind.</p>
			</div>
			...
			<div class="gallery-grids-row">
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="https://www.google.co.in/" title="Education" target="_blank">  
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g2.JPG" class="jzBoxLink item-hover" title="Education">  
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g3.JPG" class="jzBoxLink item-hover" title="Education">  
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g4.JPG" class="jzBoxLink item-hover" title="Education">  
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g5.jpg" class="jzBoxLink item-hover" title="Education">  
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g6.jpg" class="jzBoxLink item-hover" title="Education">  
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g7.JPG" class="jzBoxLink item-hover" title="Education">  
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="images/g8.jpg" class="jzBoxLink item-hover" title="Education">  
...
<div class="col-md-6 news-agileits-right news2">
		...
		<p>Cras id odio elit. Ut scelerisque pellentesque tortor, vitae sagittis metus maximus eu. Nulla vel luctus nunc, quis pulvinar mi.</p>
		<img src="images/f3.jpg" alt="image"><h6>John Stella</h6>
	</div>
	...
	<div class="col-md-6 news-agileits-right">
		...
		<p>Cras id odio elit. Ut scelerisque pellentesque tortor, vitae sagittis metus maximus eu. Nulla vel luctus nunc, quis pulvinar mi.</p>
		<img src="images/f4.jpg" alt="image"><h6>Anjelina</h6>
	</div>
	<div class="clearfix"></div>
	</div>
</div>
		...
		<div class="footer-main">
			<div class="footer-top">
				<div class="col-md-4 ftr-grid fg1">
					<h3><a href="index1.html"><span>B</span>rilliance</a></h3>
			...
			<div class="copyrights">
				<p>&copy; 2017 Brilliance. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
			</div>
		</div>
	</div>
